        ...
        <div  class="grid grid-cols-4 gap-4 flex overflow-x-scroll pb-10 hide-scroll-bar ">
          <div className="flex flex-nowrap">
                  {moviesData.slice(10,20).map((movie) => {
                    return (
                      <div className="border-2 bg-white flex-shrink-0"> 
                        <img  src={`https://image.tmdb.org/t/p/w500${movie.poster_path}`} alt="" className="border border-black overflow-hidden max-w-xs w-30 h-40 rounded-lg shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out"     />
                        <br />
