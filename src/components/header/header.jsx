...
export default function Header() {
  ...
  return (
    <header>
      <nav className=" bg-fuchsia-950 md:grid-cols-4 bg-white border-b-2 border-gray-200 px-3 lg:px-8 py-2 dark:bg-gray-900 dark:border-b-1 dark:border-gray-700 ">
        <div className="flex flex-wrap justify-between items-center mx-auto px-0 ">
          <Link to="/" className="flex items-center gap-6">
            <span className=" text-orange-500 text-xl nav-title self-center pt-1 lg:text-3xl lg:block font-semibold whitespace-nowrap dark:text-white  ">
              OnyxCinema
            </span>
          </Link>
          ...
          <div
            ...
            className={`${
              hiddenSearch ? "hidden" : ""
            } bg-fuchsia-950  items-center justify-between w-full md:flex md:w-auto md:order-1"} id="navbar-search`}
          >
